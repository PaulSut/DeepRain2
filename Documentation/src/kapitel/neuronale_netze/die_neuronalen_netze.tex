...
In der folgenden Abbildung sind die zwei 90 \% Konfidenzintervalle für die beiden Architekturen zu sehen.\\
...
\centering
\begin{tabular}[h]{l|c|c}
Verteilung & inklusive Regen & exklusive Regen  \\
\hline
UNET & \textbf{93,0} \% & \textbf{73,0} \%  \\
LSTM-Architektur &92,0 \% & 71,0 \%  \\
