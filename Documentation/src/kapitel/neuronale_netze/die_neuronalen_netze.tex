...
\end{tikzpicture}
 \caption{Abgespeckte Version des Unets  
}\label{fig:Unet1}
\end{figure}
...
Der Wertebereich der ZINB sind diskrete Werten zwischen 0-255. Die Vorhersage wird hierfür in sieben Klassen umgewandelt, so dass ein direkter Vergleich mit der Multinomialverteilung möglich ist.\\
