...
def CnnLSTM(input_shape):
    ...
    out = ConvLSTM2D(filters=8, kernel_size=(3, 3),
                       padding='same', return_sequences=False,data_format='channels_last')(batch3)

    output = Conv2D(1, (1, 1), activation='sigmoid')(out) 
